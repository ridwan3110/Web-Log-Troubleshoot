...
<div class="col-xl-12 col-sm-6 mb-3">
  <div class="card mb-3">
    <div class="card-header">
      ...
      Grafik pergantian barang Berdasarkan Part <?php// echo $_POST['status']; ?> </div>
    <div class="card-body">
    <center><i class="fas fa-circle-notch"></i> <?php echo $napro; ?> </center>

    <canvas id="bar-chart-horizontalz" width="100%" height="40"></canvas>
